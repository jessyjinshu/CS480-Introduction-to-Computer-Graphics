...
/**
 * A model for the eye of a ant as a sphere scaled in one direction.
 * 
  * @author Yuanpei Wang U14043099 wangyp@bu.edu
 * @since Fall 2018
 */
public class Eye extends Circular implements Displayable {
   ...
   */
  public Eye(final double radius, final GLUT glut) {
    super(radius, glut);
  }
