...
*/
/**
 * DragonflyDisplayable.java - an object which can draw itself using OpenGL
 */
public class DragonflyDisplayable implements Displayable{

	private int callListHandle;

	//translate with scale
	private float scale;
	...
	public DragonflyDisplayable(final float scale,final float xscale,final float yscale,final float zscale,double x,double y,double z) {
		this.scale = scale;
